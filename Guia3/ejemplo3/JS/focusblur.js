...
var arregloAyuda = [
    ...
    "Ingrese su numero de telefono en el formato 9999-0000",
    "Ingrese una descripción breve en el campo área de texto",
    "Seleccione su profesión en este campo select",
    "Diganos cál es su país de origen en este campo select",
...
function registrarEscuchas(objeto, numeroMensaje){
    ...
    //del objeto y numeroMensaje recibidos como argummentos
...
//Desencadenando la funcion inic al cargar documento
